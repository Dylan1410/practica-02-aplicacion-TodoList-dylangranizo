...
public class TareaWebTest {
    ...
    public void getNuevaTareaDevuelveForm() throws Exception {
        ...
        this.mockMvc.perform(get(urlListado))
                .andExpect(content().string(containsString("id=\"modalNuevaTarea\"")))
                .andExpect(content().string(containsString("<form action=\"/usuarios/" + usuarioId + "/tareas/nueva\" method=\"post\">")));
    }
    ...
    public void deleteTareaDevuelveOKyBorraTarea() throws Exception {
        ...
        String urlDelete = "/tareas/" + tareaLavarCocheId;
