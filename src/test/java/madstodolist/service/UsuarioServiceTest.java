...
public class UsuarioServiceTest {
    ...
    public void servicioRegistroUsuarioDevuelveUsuarioConId() {
        ...
        // ✅ Cambio aquí: usamos Usuario directamente
        Usuario usuarioBD = usuarioService.findById(usuarioNuevo.getId());

        assertThat(usuarioBD.getId()).isEqualTo(usuarioNuevo.getId());
        assertThat(usuarioBD.getEmail()).isEqualTo(usuarioNuevo.getEmail());
    }
